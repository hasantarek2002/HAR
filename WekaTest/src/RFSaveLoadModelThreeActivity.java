...
public class RFSaveLoadModelThreeActivity {
	...
	public static void main(String[] args) throws Exception {
		...
		// save model
		weka.core.SerializationHelper.write("model/rf.model", rf);
		System.out.println("RF model saved");
		
		System.out.println("Evaluation from Loaded model");
		// model evaluation
		RandomForest rf2 = (RandomForest) weka.core.SerializationHelper.read("model/rf.model");
