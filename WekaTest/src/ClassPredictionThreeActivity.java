...
public class ClassPredictionThreeActivity {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		
		//mean_x,mean_y,mean_z,magnitude_mean,std_x,std_y,std_z,magnitude_std,rms_x,rms_y,rms_z,magnitude_rms,
		//min_x,min_y,min_z,magnitude_min,max_x,max_y,max_z,magnitude_max,median_x,median_y,median_z,magnitude_median,
		//mad_x,mad_y,mad_z,magnitude_mad,corr_xy,corr_yz,corr_xz,class

		RandomForest rf = (RandomForest) weka.core.SerializationHelper.read("model/rf.model");
